 ...
 * Project: Reference router (cornell_ngrp_router)
 * Description: Reference IPv4 router
 *
 ********************************************************/

#ifndef _REG_DEFINES_CORNELL_NGRP_ROUTER_
#define _REG_DEFINES_CORNELL_NGRP_ROUTER_
...
#define DEVICE_PROJ_DIR    "cornell_ngrp_router"
